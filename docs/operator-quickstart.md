# Operator Quickstart — Community Passenger Air Transport

Shortest path from clone to a verified local dry-run for **ISIC 5110** (`cloud-itonami-isic-5110`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5110.git
cd cloud-itonami-isic-5110
```
...
- Blueprint governor key: `aviation-safety-governor`
- Likely source path: `src/**/aviation-safety-governor.cljc`
